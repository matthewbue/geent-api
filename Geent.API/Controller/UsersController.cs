...
namespace Geent.Controller
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadProfileImage([FromBody] byte[] profileImage, int userId)
        {
            ...
            try
            {
                await _userService.SaveProfileImageAsync(userId, profileImage);
        ...
        public async Task<IActionResult> GetProfileImage([FromQuery] int userId)
        {
            try
            {
                var profileImage = await _userService.GetProfileImageAsync(userId);
